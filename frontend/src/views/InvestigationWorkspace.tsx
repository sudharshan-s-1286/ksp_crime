        ...
        <div className="xl:col-span-1 flex flex-col gap-6 overflow-y-auto pr-1">
          ...
          <div className="glass-panel p-5 space-y-3 bg-zinc-900/40">
            ...
            <p className="text-xs text-zinc-300 leading-relaxed font-sans">
              Active extortion and money laundering case centering around primary target **Suresh Patil**. 
              Suspect is running protection payouts from local merchant associations. Network connects to suspect **Anand Hegde** (customs agent) and **Laxman Naik** (field operator).
            </p>
        ...
        <div className="xl:col-span-1 flex flex-col gap-6 overflow-y-auto pr-1">
          ...
          <div className="glass-panel p-5 flex-1 flex flex-col justify-between">
            <div>
              ...
              <div className="border border-dashed border-zinc-800 rounded-lg p-5 flex flex-col items-center justify-center text-center cursor-pointer hover:border-[#FF7A00] transition-colors bg-zinc-950/40">
                ...
                <p className="text-[10px] text-zinc-500 mt-1">PDF, DOCX, XLSX, MP4, JPEG up to 500MB</p>
              </div>
            </div>

            <div className="space-y-2 mt-4">
              <div className="p-2 border border-zinc-800 rounded bg-zinc-900 flex items-center justify-between text-xs">
                <span className="truncate text-zinc-400">cctv_highway_exit.mp4</span>
                <span className="text-[9px] bg-emerald-500/10 text-emerald-400 px-1 py-0.25 rounded font-mono">Ingested</span>
              </div>
              <div className="p-2 border border-zinc-800 rounded bg-zinc-900 flex items-center justify-between text-xs">
                <span className="truncate text-zinc-400">phone_records_suresh.csv</span>
                <span className="text-[9px] bg-[#FF7A00]/10 text-[#FF7A00] px-1 py-0.25 rounded font-mono">Indexing</span>
              </div>
            </div>
          </div>
        </div>
